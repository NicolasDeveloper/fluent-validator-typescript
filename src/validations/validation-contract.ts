...
export class ValidationContract extends Notifiable implements StringValidationContract, IValidatable {
    ...
    public stringHasMinLen: (val: string, min: number, property: string, message: string) => ValidationContract;
    public stringHasMaxLen: (val: string, max: number, property: string, message: string) => ValidationContract;
    public stringHasLen: (val: string, len: number, property: string, message: string) => ValidationContract;
